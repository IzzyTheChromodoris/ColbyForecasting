...
Simple feature collection with 10969 features and 2 fields
Geometry type: POINT
Dimension:     XY
Bounding box:  xmin: -73.667 ymin: 38.8414 xmax: -65.07169 ymax: 45.13174
Geodetic CRS:  WGS 84
# A tibble: 10,969 × 3
   month class                  geometry
 * <fct> <fct>               <POINT [°]>
 1 Jan   presence   (-68.65083 43.09529)
 2 Jan   presence     (-67.0988 45.0853)
 3 Jan   background (-68.31059 41.92346)
 4 Jan   background  (-68.9687 42.99289)
 5 Jan   background  (-72.8351 40.27818)
 6 Jan   background  (-70.7785 40.85403)
 7 Jan   background (-70.03813 42.33478)
 8 Jan   background (-71.76567 40.03139)
 9 Jan   background (-69.46228 41.34761)
10 Jan   background (-69.46228 41.75893)
...
```{r save_model_input}
write_model_input(obsbkg, scientificname = "Cetorhinus Maximus")
```

Note that there is a function for reading model input files, too. 

```{r read_model_input}
x = read_model_input(scientificname = "Cetorhinus Maximus")
```
